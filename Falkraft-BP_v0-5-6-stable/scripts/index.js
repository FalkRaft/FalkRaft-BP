    ...
    system.runInterval(
        () => {
            ...
            for (const player of players) {
                ...
                // const vel = Math.sqrt(player.getVelocity().x ** 2 + player.getVelocity().y ** 2 + player.getVelocity().z ** 2);
                // player.getComponent(EntityComponentTypes.Movement).setCurrentValue(vel);
            }
        }, 0
    );
}
