...
/**
 * States specific to Carpet
 */
export declare type CarpetStates = Pick<BlockStateSuperset, 'color'>;
/**
 ...
 */
export declare type CarvedPumpkinStates = Pick<BlockStateSuperset, 'direction'>;
/**
...
/**
 * States specific to Coral
 */
export declare type CoralStates = Pick<BlockStateSuperset, 'coral_color' | 'dead_bit'>;
/**
...
/**
 * States specific to LavaCauldron
 */
export declare type LavaCauldronStates = Pick<BlockStateSuperset, 'cauldron_liquid' | 'fill_level'>;
/**
 ...
 */
export declare type LitPumpkinStates = Pick<BlockStateSuperset, 'direction'>;
/**
 ...
 */
export declare type PumpkinStates = Pick<BlockStateSuperset, 'direction'>;
/**
...
export declare type BlockStateMapping = {
    ...
    [MinecraftBlockTypes.Carpet]: CarpetStates;
    ...
    [MinecraftBlockTypes.Coral]: CoralStates;
    ...
    [MinecraftBlockTypes.LavaCauldron]: LavaCauldronStates;
